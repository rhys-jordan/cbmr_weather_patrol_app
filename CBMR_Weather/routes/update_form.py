...
from CBMR_Weather.routes import bp_update_form
...
@bp_update_form.route('/update-form/<inputDate>', methods=['GET', 'POST'])
@login_required
def update_form(inputDate):
    if request.method == 'POST':
        ...
        # Avalanche Problems
        avalanche_problem_1, btl_aspect_1, ntl_aspect_1, atl_aspect_1, size_1, likelihood_1, location_1 = get_avalanche_problem(1)
        avalanche_problem_2, btl_aspect_2, ntl_aspect_2, atl_aspect_2, size_2, likelihood_2, location_2 = get_avalanche_problem(2)
        avalanche_problem_3, btl_aspect_3, ntl_aspect_3, atl_aspect_3, size_3, likelihood_3, location_3 = get_avalanche_problem(3)
        avalanche_problem_4, btl_aspect_4, ntl_aspect_4, atl_aspect_4, size_4, likelihood_4, location_4 = get_avalanche_problem(4)
        ...
        snow = Snow(dateTime=dateTime,date=date, day=day, month=month, year=year,
                    ...
                    temperature=current_temperature, wind_mph=wind_mph, wind_direction=wind_direction,
                    ...
                    past_24_hst=past_24_hst, past_24_settlement=past_24_settlement,past_24_date_cir=past_24_date_cir,
                    future_precip_rate=future_precip_rate, past_24_hn24_swe=past_24_hn24_swe, past_24_hn24=past_24_hn24,
                    past_24_hn24_percent=past_24_hn24_percent, future_temp_high=future_temp_high, past_24_wind_mph=past_24_wind_mph,
                    past_24_wind_direction=past_24_wind_direction, future_temp_low=future_temp_low, past_24_temp_high=past_24_temp_high,
                    future_wind_mph=future_wind_mph, past_24_temp_low=past_24_temp_low, future_wind_direction=future_wind_direction,
                    avalanche_danger_resort=avalanche_danger_resort, avalanche_danger_backcountry=avalanche_danger_backcountry,
                    pwl=pwl,pwl_date=pwl_date,current_peak_gust_mph=current_peak_gust_mph,current_peak_gust_direction=current_peak_gust_direction,
                    current_peak_gust_time=current_peak_gust_time,past_24_peak_gust_mph=past_24_peak_gust_mph,past_24_peak_gust_direction=past_24_peak_gust_direction,
        ...
        if avalanche_problem_2:
            avy2 = Avalanche(problem=avalanche_problem_2, size=size_2, likelihood=likelihood_2, btl_aspect=btl_aspect_2,
                             ntl_aspect=ntl_aspect_2, atl_aspect=atl_aspect_2, location=location_2, Snow_id=id)
            db.session.add(avy2)
        if avalanche_problem_3:
            avy3 = Avalanche(problem=avalanche_problem_3, size=size_3, likelihood=likelihood_3, btl_aspect=btl_aspect_3,
                             ntl_aspect=ntl_aspect_3, atl_aspect=atl_aspect_3, location=location_3, Snow_id=id)
            db.session.add(avy3)
        if avalanche_problem_4:
            avy4 = Avalanche(problem=avalanche_problem_4, size=size_4, likelihood=likelihood_4, btl_aspect=btl_aspect_4,
                             ntl_aspect=ntl_aspect_4, atl_aspect=atl_aspect_4, location=location_4, Snow_id=id)
            db.session.add(avy4)
